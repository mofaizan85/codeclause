...
frame = tk.Frame(master=root, bg="black", padx=10)
frame.pack()
...
button_subtract = tk.Button(
    master=frame, text="-", padx=15, pady=5, width=3, command=lambda: click('-'))
...
button_equal = tk.Button(master=frame, text="=", padx=12,
