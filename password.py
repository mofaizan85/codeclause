...
root.title("Random Password Generator - Scaler Topics")
...
def passwordGeneration(n):
    ...
    l = Label(root, text=password, font=('bold', 15))  # displaying password
    l.place(x=225, y=65)
...
# creating buttons
Button(root, text='Generate Password', font=('normal', 10),
